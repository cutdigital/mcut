...
namespace mcut
{
    ...
    void polygon_normal(math::vec3& normal, const math::vec3* vertices, const int num_vertices)
    {
      ...
      normal = normalize(normal);
        ...
        {
            return orient3d(pa, pb, pc, pd) == mcut::math::real_number_t(0.);
        }
