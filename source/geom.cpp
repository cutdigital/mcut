                                       ...
                                       const math::vec3 *polygon_vertices, const int polygon_vertex_count)
{
    ...
    {
        normal = normal + cross_product(polygon_vertices[i] - polygon_vertices[0],
...
char compute_segment_line_plane_intersection_type(const math::vec3 &q, const math::vec3 &r,
                                                  const std::vector<math::vec3> &polygon_vertices,
...
// violates GP).
char compute_line_plane_intersection(math::vec3 &p, // intersection point
                                     const math::vec3 &q, const math::vec3 &r,
...
// 'v': q is a vertex.
char compute_point_in_polygon_test(const math::vec2 &q, const std::vector<math::vec2> &polygon_vertices)
{
    const int polygon_vertex_count = (int)polygon_vertices.size();
